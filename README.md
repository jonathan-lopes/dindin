...
Para acessar o repositório da API que será consumida no front, acesse o seguinte [link](https://github.com/jonathan-lopes/api-dindin).
...
Acesse a aplicação no seguinte [link](https://finance-dindin.netlify.app/).
...
```sh
  $ cd dindin # para acessar a pasta clonada do git
